const biographyData = {
  Aatrox: {
    biography: `Whether mistaken for a demon or god, many tales have been told of the Darkin Blade... but few know his real name, or the story of his fall.
  ...
  Ahri: {
    biography: `For most of her life, Ahri's origins were a mystery to her, the history of her vastayan tribe all but lost save for the twin gemstones she has carried her entire life. 
  ...
  Akali: {
    biography: `Ionia has always been a land of wild magic, its vibrant people and powerful spirits seeking to live in harmony… but sometimes this peaceful equilibrium does not come easily. Sometimes it needs to be kept in check.
  ...
  Akshan: {
    biography: `Dashing through the shadows of eastern Shurima, a righteous avenger stalks those who have harmed others. His punishment is swift, certain, and exacted by a curious weapon that rights the wrongs of his foes.
  ...
  Alistar: {
    biography: `Many civilizations have resisted Noxus, but none as long as the clans of the Great Barrier mountains. Though these fierce minotaurs had protected the overland trade routes to the ancient city of Zaun for centuries, they preferred to avoid Valoran’s wider conflicts.
  ...
  Anivia: {
    biography: `Anivia is an ancient Freljordian demi-god who represents the eternal cycle of life, death, and rebirth, intrinsically associated with the changing seasons. To those who venerate her, she is the elemental soul of the Freljord—a symbol of hope, and a sacred catalyst of change.
  ...
  Annie: {
    biography: `Boram Darkwill’s last years on the throne were a time of great uncertainty for Noxus, and many with an aptitude for magic left the capital for the relative peace of more distant provinces. Gregori the Gray and his wife, a witch by the name of Amoline, preferred to demonstrate their Noxian strength by taming the borderlands, rather than partaking in the political intrigue of the noble houses.
  ...
  Aphelios: {
    biography: `The moon looms over the towering slopes of Mount Targon, distant, yet impossibly close.
  ...
  Ashe: {
    biography: `Ashe hails from the northern Freljord, where brutal tribal raids and inter-clan warfare are as much a part of the landscape as the scream of the frozen winds, and the unyielding cold of the tundra.
  ...
  AurelionSol: {
    biography: `The appearance of a comet in the night sky is often said to portend upheaval and unrest. Under the auspices of such fiery harbingers, new empires rise, old cultures fall, and even the stars themselves may vanish from the heavens…
  ...
  Belveth: {
    biography: `Fascinated by the world of existence and eager to create one for herself, Bel’Veth is like a dark cancer that has metastasized within the heart of the Void, through which all of Runeterra will be consumed and rebuilt in her own twisted image. She hungers for new experiences, memories, and concepts in vast amounts, devouring whole cities and their populations before repurposing the information into a sprawling alien landscape known as the Lavender Sea. Yet even the Void is not safe from her voracity as she spreads within it like a primordial ocean, forcing all before her to submit to her world of want... or be destroyed.
  ...
  Braum: {
    biography: `Even as a child, Braum was much larger than other Freljordian youngsters, but his mother taught him never to use his size to intimidate or bully. She came from a proud line of herders, and believed true courage lay in using one’s power not to dominate, but to protect those in need.
  ...
  Camille: {
    biography: `Clan Ferros understands sacrifice.
  ...
  Cassiopeia: {
    biography: `The youngest child of General Du Couteau, Cassiopeia was born to a life of possibility and privilege among the Noxian noble houses. From an early age, she displayed a keen mind and sharp wit, and while her sister Katarina flourished under their father’s tutelage, it was their mother Soreana in whose footsteps Cassiopeia would follow.
  ...
  DrMundo: {
    biography: `In the wards of Zaun’s infamous asylum, a single monstrous figure roams the halls. His methods are bold, his bonesaw is sharp, and his patients are terrified. For this man is no doctor at all, except in the fancy of his own mind.
  ...
  Elise: {
    biography: `The Lady Elise was born centuries ago to House Kythera, one of the oldest bloodlines of Noxus, and swiftly learned the power of beauty to influence the weak.
  ...
  Fiddlesticks: {
    biography: `Long, long ago, in a tower by the edge of the sea, a foolish young mage summoned something into the world that he was not prepared to control. What stepped before the boy was something older than recorded history. Something darker than a yawning, starless night. Something the world had desperately tried to forget—and in an instant, the mage, the creature, and the tower itself were lost to all of time.
  ...
  Gangplank: {
    biography: `As unpredictable as he is brutal, the dethroned reaver king known as Gangplank is feared far and wide. Where he goes, death and ruin follow, and such is his infamy and reputation that the merest sight of his black sails on the horizon causes panic among even the hardiest crew.
  ...
  Garen: {
    biography: `Born into the noble Crownguard family, along with his younger sister Lux, Garen knew from an early age that he would be expected to defend the throne of Demacia with his life. His father, Pieter, was a decorated military officer, while his aunt Tianna was Sword-Captain of the elite Dauntless Vanguard—and both were recognized and greatly respected by King Jarvan III. It was assumed that Garen would eventually come to serve the king’s son in the same manner.
  ...
  Gnar: {
    biography: `Before the ice had given the Freljord its name, there existed a land brimming with wonder—that is, if one could see the world through the eyes of Gnar.
  ...
  Gwen: {
    biography: `Within the long-lost kingdom of Camavor, there once lived a village of people far from the throne. It was here, in the rural colonies, where a humble seamstress made her beloved doll, Gwen.
  ...
  Hecarim: {
    biography: `Born into an empire long since gone to dust and forgotten, Hecarim was a lieutenant of the Iron Order—a brotherhood sworn to defend their king’s lands.
  ...
  Heimerdinger: {
    biography: `A brilliant yet eccentric yordle scientist, Professor Cecil B. Heimerdinger is lauded as one of the most innovative minds and esteemed inventors Piltover has ever seen. Relentless in his work to the point of neurotic obsession, he is fascinated by mysteries that have confounded his contemporaries for decades, and thrives on answering the universe’s most impenetrable questions. Though his theories often appear opaque and esoteric, Heimerdinger believes knowledge should be shared, and is devoted to teaching all who desire it.`,
  },
  Hwei: {
    biography: `In northwest Ionia, the island of Koyehn once stood beautiful and serene. Among its golden sands, seasonal bazaar, and quaint mill town sat the Temple of Koyehn, an ancient and renowned conservatory for the arts.
  ...
  Illaoi: {
    biography: `Illaoi’s powerful physique is dwarfed only by her indomitable faith. As the prophet of the Great Kraken, she uses a huge, golden idol to rip her foes’ spirits from their bodies and shatter their perception of reality. All who challenge the “Truth Bearer of Nagakabouros” soon discover Illaoi never battles alone - the god of the Serpent Isles fights by her side.
  ...
  Ivern: {
    biography: `Ivern the Cruel was renowned as a fierce warrior, in the latter days of the ancient Vorrijaard. His clan followed the most warlike of the old gods, and would not kneel before the upstart “Three Sisters” like so many others had.
  ...
  Janna: {
    biography: `Since ancient times, there have been those who prayed to the winds. From sailors seeking good weather to the downtrodden calling on winds of change, mortals have placed their hope in the tempests and gales that sweep across Runeterra.
  ...
  JarvanIV: {
    biography: `Soon after King Jarvan III’s coronation, he addressed the people of Demacia. Even though there were still many foes beyond the borders of their proud kingdom, several of the noble families had begun to feud with one another, some even raising private militias to seek the favor of their new king.
  ...
  Jhin: {
    biography: `One can travel to nearly any village across Ionia and hear the tale of the Capture of the Golden Demon. Depicted in a variety of plays and epic poems, the cruel spirit’s banishment is still celebrated to this day.
  ...
  Kalista: {
    biography: `In life, Kalista was a proud general, niece to the king of an empire that none now recall. She lived by a strict code of honor, serving the throne with utmost loyalty. The king had many enemies, and when they sent an assassin to slay him, it was Kalista’s vigilance that averted disaster.
  ...
  Karma: {
    biography: `Karma is the living embodiment of an ancient Ionian soul, who serves as a spiritual beacon to each generation of her people. Her most recent incarnation came in the form of a 12-year-old girl named Darha. Raised in the northern highlands of Shon-Xan, she was headstrong and independent, always dreaming of a life beyond her provincial village.
  ...
  Kassadin: {
    biography: `Kassadin started life as a lowly offcast, walking the harsh sands of the Great Sai alongside merchant caravans to draw predators away from their more valuable goods. He survived many of these treks across the desert, and began to serve less as bait, and more as a guide.
  ...
  Katarina: {
    biography: `Born to one of the most respected noble families of Noxus, Katarina Du Couteau found herself elevated above others from an early age. While her younger sister Cassiopeia took after their politically brilliant mother, Katarina was very much her father’s daughter, and the wily General Du Couteau pushed her to learn the way of the blade; to cut away the empire’s enemies not with reckless brutality, but deadly precision. He was a harsh teacher with many pupils, and notoriously difficult to impress.
  ...
  Kayle: {
    biography: `As the Rune Wars raged, Mount Targon stood as a beacon against the oncoming darkness—Kayle and her twin sister Morgana were born beneath that light. Their parents, Mihira and Kilam, began the perilous climb in search of the power to save their tribe from destruction.
  ...
  Kayn: {
    biography: `Noxian by birth, Shieda Kayn and others like him were conscripted as child soldiers, a cruel practice employed by only the most devious commanders in Boram Darkwill’s empire. Following the disastrous battle at the Placidium of Navori, the invasion was deliberately reformulated into a protracted war of attrition. Ionian compassion was a weakness to be exploited—their warriors would hesitate before striking down a supposed innocent. Thus, barely able to lift the blade he had been given, Kayn’s first day in battle was also expected to be his last.
  ...
  Kennen: {
    biography: `A riotous domain of constant transformation, Bandle City was no place for a yordle like Kennen. Searching for harmony and balance, he ventured out from the spirit realm millennia ago. He explored the material realm with boundless curiosity, traveling great distances in a heartbeat. But he was drawn in particular to Ionia.
  ...
  Khazix: {
    biography: `A vicious Void predator, Kha'Zix infiltrated Valoran to devour the land's most promising creatures. With each kill he absorbs his prey's strength, evolving to grow more powerful. Kha'Zix hungers most to conquer and consume Rengar, the one beast he considers his equal.
  ...
  Kindred: {
    biography: `Separate, but never parted, Kindred represents the twin essences of death. Lamb’s bow offers a swift release from the mortal realm for those who accept their fate. Wolf hunts down those who run from their end, delivering violent finality within his crushing jaws. Though interpretations of Kindred’s nature vary across Runeterra, every mortal must choose the true face of their death.
  ...
  Kled: {
    biography: `Legends of the popular folk hero Kled can be traced back to the founding of Noxus, and perhaps even further still. He is an icon revered by the common soldiery, which is increasingly a cause of concern to their commanders—for there are some among the warhosts who claim to have literally served beside him.
  ...
  Leblanc: {
    biography: `Matron of the Black Rose, LeBlanc’s identity is as intangible as the whispers that describe her, as ephemeral as the illusions that give her shape. Perhaps it is unknown even to herself, after so many centuries of mimicry and deception…
  ...
  LeeSin: {
    biography: `Among the many spirits Ionians revere, none are as storied as that of the dragon. While some believe it embodies ruin, others view it as a symbol of rebirth. Few can say for certain, and fewer still have ever been able to channel the dragon’s spirit, and none so completely as Lee Sin.
  ...
  Leona: {
    biography: `Among the Rakkor tribes that dwell upon Mount Targon, the sun is sacred, and none venerate it more than the Solari. Children are raised from birth to honor it, and even to shed blood for it, until its Aspect returns, heralding a grave threat they all must face.
  ...
  Lillia: {
    biography: `In Ionia, magic is woven into the land. Forests spread vibrantly, and trees often boast nearly as many colors as leaves, touched by the wonders of the spirit realm.
  ...
  Lissandra: {
    biography: `In a time long forgotten, before the sands birthed and then swallowed Shurima, beings of old magic freely walked Runeterra. The borders between the mortal realm and what lay beyond it were hotly contested.
  ...
  Lucian: {
    biography: `From an early age, Lucian wanted nothing more than to be like his father, Urias, who was a member of the ancient order of the Sentinels of Light. While Lucian remained home in Demacia, Urias ranged far and wide, protecting the living from the wraiths of the Black Mist.
  ...
  Malphite: {
    biography: `For more than two millennia, Shurima dominated the known world—an empire that reigned over countless peoples without challenge, and without threat.
  ...
  MasterYi: {
    biography: `In Ionia’s central province of Bahrl, a mountain settlement once stood, hidden away in its serene beauty. Here, in the village of Wuju, the boy Yi grew up learning the ways of the sword, chasing a dream that later turned to tragedy.
  ...
  MissFortune: {
    biography: `Like most who rise to notoriety in the twisting, salt-crusted labyrinth of Bilgewater, Sarah Fortune has no shortage of blood on her hands…
  ...
  Naafiri: {
    biography: `In the pitch black Shuriman night, few sounds are as terrifying as the howls of the dune hound. Those who hear their piercing call on the arid wind know to keep a hand on their sword hilt, and their horse well rested, for the ravenous packs that rove these sands will chase whatever game they can find in their desert.
  ...
  Nami: {
    biography: `A headstrong young vastaya of the seas, Nami uses her mystical Tidecaller staff to reshape the tides and defend her fellow Marai from danger. The first of her kind to leave the ocean and venture onto dry land, Nami faces the unthinkable with grit, determination, and daring mettle.
  ...
  Nasus: {
    biography: `Nasus’ brilliance was recognized long before he was chosen to join the ranks of the Ascended. A voracious student, he memorized and critiqued the greatest works of Shuriman history and philosophy before he was ten.
  ...
  Nautilus: {
    biography: `To understand the legend of Nautilus, one must first know the man—for even the tallest of tavern tales agree, he was indeed a man.
  ...
  Nidalee: {
    biography: `Far, far from the harsh deserts of the Great Sai, over savanna plains and mountain steppes, lie the great jungles on the border of Ixtal and Shurima. Swathed in mystery, they are home to wild, fantastical beasts, and dense forests blooming with life. But while there is overwhelming beauty to be found there, danger and death lurk nearby in equal measure.
  ...
  Nocturne: {
    biography: `While all magic can be dangerous and unpredictable, there are some forms or disciplines that even the most skilled mages and sorcerers will shun, and with good reason. For centuries, the practice of “shadow magic” was all but forbidden across Runeterra, for fear of reawakening the horrors it once unleashed upon the world.
  ...
  Ornn: {
    biography: `Ornn’s name was once spoken throughout the lands that would one day become known as the Freljord. It was widely held that he was the firstborn of the old demi-gods, who had shaped the land itself, and brought forth the first snows.
  ...
  Pantheon: {
    biography: `Atreus was born on the hostile slopes of Targon, and named after a star in the constellation of War, known as the Pantheon.
  ...
  Poppy: {
    biography: `Runeterra has no shortage of valiant champions, but few are as tenacious as Poppy. Bearing a hammer twice the length of her body, this determined yordle has spent untold years searching for the “Hero of Demacia,” a fabled warrior said to be the rightful wielder of her weapon.
  ...
  Qiyana: {
    biography: `The youngest child in a ruling family, Qiyana grew up believing she would never inherit the high seat of the Yun Tal. As her parents governed Ixaocan, a city-state hidden deep in the jungles of Ixtal, they raised their children to succeed them, schooling them in the proud traditions of their isolated nation. Primed to rule before her, Qiyana’s nine older sisters received most of the attention, and she often longed to find her own meaningful place in the family.
  ...
  Quinn: {
    biography: `Quinn and her twin brother, Caleb, were born in Uwendale, a remote mountain hamlet in northeastern Demacia. It was a thriving village of hunters and farmers, protected by rangers who patrolled the wilderness and drove off any dangerous creatures wandering down from the high peaks.
  ...
  Rakan: {
    biography: `The Lhotlan vastaya once lived on the ancient, mystical borders of Ionia’s deep forests, on the eastern island of Qaelin. It was a place where magic was breathed like air, and time had little meaning. To these chimeric creatures, the lands of mortals were an unforgiving desert, virtually devoid of magic—and over the centuries, that desert only grew, encroaching on the vastaya’s territories.
  ...
  RenataGlasc: {
    biography: `Life had not always been good to Renata Glasc.
  ...
  Renekton: {
    biography: `Renekton was born to fight. From a young age, it was obvious he had no fear, regularly brawling with much older children. It was usually his pride that led to these confrontations—Renekton was unable to back down, or let any insult pass. While his older brother, Nasus, disapproved of his street-fighting, Renekton relished it.
  ...
  Rengar: {
    biography: `Rengar hails from a tribe of Shuriman vastaya known as the Kiilash, whose society venerated the honor and glory of the hunt. Rengar was born the runt of the litter to the tribe's chieftain, Ponjaf. Ponjaf believed Rengar's diminutive size would make him a worthless hunter. He ignored his child, assuming the runt would starve to death.
  ...
  Riven: {
    biography: `Built on perpetual conflict, Noxus has never had a shortage of war orphans. Her father lost to an unnamed battle and her mother to the girl’s own stubborn birth, Riven was raised on a farm run by the empire on the rocky hillsides of Trevale.
  ...
  Rumble: {
    biography: `Even amongst yordles, Rumble was always the runt of the litter. As such, he was used to being bullied. In order to survive, he had to be scrappier and more resourceful than his peers. He developed a quick temper and a reputation for getting even, no matter who crossed him. This made him something of a loner, but he didn't mind. He liked to tinker, preferring the company of gadgets, and he could usually be found rummaging through the junkyard.
  ...
  Ryze: {
    biography: `Ryze was just a young apprentice when he first learned of the arcane powers that had shaped the world.
  ...
  Samira: {
    biography: `In the city of Amakra, on the eastern edge of the Great Sai, Samira and her parents made a living as street performers. They dazzled, beguiled, and awed onlookers, which thrilled Samira, but worried her parents. Despite the fun their daughter had, they wished she could enjoy a more stable life.
  ...
  Sejuani: {
    biography: `Sejuani was the child of a Freljordian political marriage that ended as coldly as it began. Her mother, the Iceborn warrior Kalkia of the Winter’s Claw, abandoned her new family to pursue the man who had captured her heart years before, and the tribe fell into decline and chaos without a young Warmother to lead it.
  ...
  Senna: {
    biography: `Senna’s journey to become a Sentinel of Light started with darkness. It started with the Black Mist…
  ...
  Seraphine: {
    biography: `In Piltover, where anyone’s dream can become everyone’s progress, a star is born.
  ...
  Shen: {
    biography: `An enigma to the spirit realm, as well as the mortal world, Shen belongs to neither. Although born to one of the most revered families of northern Navori, it was his father’s role as the Eye of Twilight that set his destiny in the Kinkou Order.
  ...
  Shyvana: {
    biography: `Though they are rare creatures now indeed, there exist a handful of places across Runeterra where the great elemental dragons still nest.
  ...
  Singed: {
    biography: `The twisted, unfathomable madman known across Runeterra as Singed began his life as an ordinary man in Piltover. As a child, he displayed a prodigious intellect and a boundless sense of curiosity. The principles and interactions of the natural world fascinated him, eventually leading him to pursue a scholarship at the prestigious University of Piltover.
  ...
  Skarner: {
    biography: `Long before the rise of Shurima’s great empire, the remote northwestern valleys were home to an age-old race known as the brackern.
  ...
  Smolder: {
    biography: `Long before the lands that would become Camavor were named, dragons dwelt there.
  ...
  Sona: {
    biography: `Sona’s earliest memories are of the Ionian monastery where she was raised, in the province of Galrin. The monks, along with kindhearted volunteers from the local villages, took in any orphans or foundlings left at the front gates, and made sure that they would want for nothing.
  ...
  Soraka: {
    biography: `An age ago, when time itself was young, the inhabitants of the celestial realm regarded the fledgling races of Runeterra with growing concern.
  ...
  Swain: {
    biography: `Born into a patrician family, one of many to exist since the first walls were raised around Noxus, Jericho Swain seemed destined for a life of privilege. The noble houses had played a key role in Boram Darkwill’s rise to power, stoking rhetoric that their proud heritage was the nation’s greatest strength.
  ...
  Sylas: {
    biography: `As a mage born to a poor Demacian family, Sylas of Dregbourne was perhaps doomed from the start. Despite their low social standing, his parents were firm believers in their country’s ideals. So, when they discovered their son was “afflicted” with magical abilities, they convinced him to turn himself in to the kingdom’s mageseekers.
  ...
  Teemo: {
    biography: `Teemo is a legend among his yordle brothers and sisters in Bandle City. As far as yordles are concerned, there is something just slightly off about him. While Teemo enjoys the companionship of other yordles, he also insists on frequent solo missions in the ongoing defense of Bandle City. Despite his genuinely warm personality, something switches off inside Teemo's mind during combat so that the lives he must end while on patrol do not burden him. Even as a young recruit, the drill instructors and other trainees found it a little disconcerting that, while Teemo was normally charming and kind, he turned deadly serious and highly efficient the minute combat exercises began. Teemo's superiors quickly steered him toward the Scouts of the Mothership, which is one of Bandle City's most distinguished Special Forces unit alongside the Megling Commandos.
  ...
  Thresh: {
    biography: `The horrifying specter now known as Thresh was once a simple, if troubled, man. In an age history has all but forgotten, he was a lowly warden of an order devoted to the gathering and protection of arcane knowledge. This order was established on the Blessed Isles, which were hidden and protected from the outside world by magical pale mists.
  ...
  Tristana: {
    biography: `Like most yordles, Tristana was always fascinated by the world beyond Bandle City. She traveled far and wide, full of wonder and enthusiasm for the varied places, people, and creatures she encountered. Using the hidden pathways that only yordles know, she explored the length and breadth of the material realm, remaining mostly unseen.
  ...
  TwistedFate: {
    biography: `Born to the nomadic river folk of the Serpentine Delta, the boy Tobias Felix quickly learned what it was to be an outsider. Tolerated for the exotic goods they peddled, but shunned for their strange traditions, his people found only short welcomes wherever they berthed their colorful river barques. His elders would shrug, and say this was just the way of the world… but the obvious prejudice always stuck in Tobias’ craw.
  ...
  Urgot: {
    biography: `Urgot always believed he was worthy.
  ...
  Varus: {
    biography: `Regardless of what he would later become, Varus was once a paragon of loyalty and honor. A skilled archer of the ancient Shuriman empire, he was appointed as a temple warden in the eastern states, and he held this duty sacred above all else.
  ...
  Veigar: {
    biography: `For most of the peoples of Runeterra, yordles are not typically something to be feared. Their fabled home of Bandle City is said to be a mysterious, spiritual place, filled with odd trinkets and keepsakes gathered from across the material realm. While these curious creatures often leave to dwell among mortal races for a time, they generally return with fresh tales and new experiences to recount.
  ...
  Velkoz: {
    biography: `To truly understand the horror that is Vel’Koz, one must first know of the Watchers, and how they were blinded to the mortal realm.
  ...
  Vex: {
    biography: `In the black heart of the Shadow Isles, a lone yordle trudges through the spectral fog, content in its murky misery. With an endless supply of malaise and a powerful shadow in tow, Vex shields herself from the pep and happiness of the outside world, and all of the irksome “normies” who occupy it.
  ...
  Viego: {
    biography: `Few know of the kingdom to the east, far across the seas, whose name lies all but forgotten among the ruins that dot its shores. Fewer still know of its foolish young ruler, whose lovestruck heart was doomed to destroy it.
  ...
  Volibear: {
    biography: `To some, he is the Thunder’s Roar, the Greatstorm, or Valhir. To others, he is Ruin, the Thousand-Pierced Bear, or He Who Stands. But to most of the tribes who still hold to the old ways, he is known as the Volibear.
  ...
  Wukong: {
    biography: `Within Ionia’s magical forests dwells a tribe of vastaya known as the Shimon. A cautious people, they see life as an evolutionary climb to wisdom—upon death, they believe they become stones, returning to the soil to begin the climb of life anew.
  ...
  Xayah: {
    biography: `As a child of the Lhotlan tribe, Xayah loved listening to her father sing folk-hymns about ancient vastayan heroes. The haunting melodies transported her to a long-forgotten time, when magic danced freely through the island of Qaelin, imbuing the Lhotlan with immense power.
  ...
  Yasuo: {
    biography: `As a child, Yasuo often believed what the others in his village said of him: on the best days, his very existence was an error in judgement; on the worst, he was a mistake that could never be undone.
  ...
  Yone: {
    biography: `In life, Yone adhered to a strict code of honor and duty. Even as a child, his love for his family led him to assume the mantle of protector, motivated in no small way by the loss of his father. This was in stark contrast to his half-brother, Yasuo, who was brash and reckless where Yone was patient and disciplined.
  ...
  Yuumi: {
    biography: `In the outlands of Bandle City, there was once a wooded glen where the moon-moths glimmered and the riverbanks overflowed with rainbowfish. In a cottage nestled between the verdant trees lived a yordle enchantress named Norra, with her cat, Yuumi.
  ...
  Zed: {
    biography: `Beneath Ionia’s veil of harmony lie the tales of those left behind. For Zed, his story began as a boy on the cold steps of the home of the Kinkou Order.
  ...
  Zeri: {
    biography: `Raised in a large working-class family, Zeri grew up surrounded by warmth, care, and many strong opinions. They were no strangers to hardship, having lost loved ones to Zaun’s dangers. Even so, their community was their strength.
  ...
  Zilean: {
    biography: `Icathia, most desolate and cursed of lands, was not always so. Theirs was a rich and diverse civilization, ruled by benevolent Axamuk, last of the Mage Kings of old. As the Shuriman empire expanded across the continent, Axamuk’s calls for peaceful coexistence were ignored, and his armies destroyed by the god-warriors of the Ascended Host.
  ...
  Zyra: {
    biography: `Zyra’s memory is long, and runs as deep as the roots of the earth. Her kind was young when the Rune Wars raged, when mortal armies fought one another for the very keys of creation.
...
export function fetchBiographyData() {
